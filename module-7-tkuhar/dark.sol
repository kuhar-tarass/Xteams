...
contract Multiownable {
    ...
    */
    ...
    function checkHowManyOwners(uint howMany) internal returns(bool) {
        ...
        // bytes32 owner_Gener= keccak256(bytes(ownersGeneration)); 
        bytes32 operation = keccak256(msg.data)^keccak256(abi.encode(ownersGeneration));
        // 
...
contract MULTIwallet is Multiownable {
    ...
    constructor(address[] memory Owners, uint256 HowManyOwnersDecide) public{
        transferOwnershipWithHowMany(Owners, HowManyOwnersDecide);
    }
    ...
    function transferTo(address payable to, uint256 amount) onlyManyOwners public{
...
contract Factory{
    ...
    function createNewContarct(address[] memory Owners, uint256 HowManyOwnersDecide) public returns(address){
        MULTIwallet n = new MULTIwallet(Owners, HowManyOwnersDecide);
        return address(n);
    }
}
